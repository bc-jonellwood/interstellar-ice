    ...
    return (
      ...
      {toggled && (
        <motion.div
          ...
          animate="visible"
          initial="hidden"
          className="fixed left-0 top-0 z-40 flex h-screen w-full flex-col items-center justify-center gap-24 bg-sky-300 text-2xl font-bold">
          <NavLinks
      ...
      <motion.div
        ...
        className={"burger z-50 cursor-pointer space-y-1.5"}
      >
        <motion.span
          animate={{ rotateZ: toggled ? 45 : 0, y: toggled ? 8 : 0 }}
          className="line line-1 block h-0.5 w-8 bg-content bg-slate-900"
        ></motion.span>

        <motion.span
          animate={{ width: toggled ? 0 : 24 }}
          className=" line line-2 block h-0.5 w-6 bg-content bg-slate-900"
        ></motion.span>
        <motion.span
          animate={{
          ...
          className="line-3 block h-0.5 w-4 bg-content bg-slate-900"
        ></motion.span>
      </motion.div>
    </nav>
    )
